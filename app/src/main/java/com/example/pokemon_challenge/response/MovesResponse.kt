...
data class MovesResponse(
	...
	val generation: MovesGeneration? = null,
	...
	val names: List<NameMoveItem?>? = null,
...
data class NameMoveItem(

	@field:SerializedName("name")
	val name: String? = null,

	@field:SerializedName("language")
	val language: MovesLanguage? = null
)
